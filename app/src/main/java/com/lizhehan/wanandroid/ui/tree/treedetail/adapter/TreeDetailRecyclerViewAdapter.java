...
public class TreeDetailRecyclerViewAdapter extends BaseQuickAdapter<TreeDetailBean.DatasBean, BaseViewHolder> {

    public TreeDetailRecyclerViewAdapter(int layoutResId, @Nullable List<TreeDetailBean.DatasBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, TreeDetailBean.DatasBean item) {
